...
<div class="adv"> 
            <div class="right">
                <div class="block">
                    <h1><strong><%=infoTT.Ten %></strong></h1>
                    <p class="news-info"><%=infoTT.NgayDang %></p>
                    ...
                    <div class="content">
                        <p style="text-align: justify;"><%=infoTT.Noidung %></p>
                    </div>
                    <img src="<%="..\\Resource\\Images\\" +infoTT.HinhAnh%> width="600px" height="350px" " alt="">
                </div>
            </div>
        </div>